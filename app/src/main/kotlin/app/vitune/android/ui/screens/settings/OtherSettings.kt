    ...
    SettingsCategoryScreen(
        ...
        SettingsGroup(title = "App Updates") {
            SwitchSettingsEntry(
                ...
                text = "Automatically check for new app versions on startup",
                isChecked = UpdatePreferences.autoCheckUpdates,
                onCheckedChange = { UpdatePreferences.autoCheckUpdates = it }
            )

            SwitchSettingsEntry(
                title = "Auto-download updates",
                text = "Automatically download updates when available",
                isChecked = UpdatePreferences.autoDownloadUpdates,
                onCheckedChange = { UpdatePreferences.autoDownloadUpdates = it }
            )

            SettingsEntry(
                title = "Check for updates now",
                text = "Manually check for app updates",
                onClick = {
                    // This will be handled by the update system
