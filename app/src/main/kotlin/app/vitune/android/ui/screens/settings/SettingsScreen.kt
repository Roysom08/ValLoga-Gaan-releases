    ...
    RouteHandler {
        ...
        Content {
            Scaffold(
                ...
                tabColumnContent = {
                    tab(0, R.string.appearance, R.drawable.color_palette, canHide = true)
                    tab(1, R.string.player, R.drawable.play, canHide = true)
                    tab(2, R.string.cache, R.drawable.server, canHide = true)
                    tab(3, R.string.database, R.drawable.server, canHide = true)
                    tab(4, R.string.other, R.drawable.shapes, canHide = true)
                    tab(5, R.string.about, R.drawable.information, canHide = true)
                }
            ) { currentTabIndex ->
