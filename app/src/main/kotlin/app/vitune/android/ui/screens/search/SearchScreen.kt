    ...
    RouteHandler {
        ...
        Content {
                ...
                Box {
                    AnimatedVisibility(
                        ...
                        BasicText(
                            ...
                            maxLines = 1,
                            style = LocalAppearance.current.typography.s.secondary
                        )
                    }
            ...
            Scaffold(
                ...
                onSearchClick = null, // Disable search icon since we have search input
                searchInputContent = {
                    ...
                    BasicTextField(
                        ...
                        textStyle = typography.s.copy(color = colorPalette.text),
                        singleLine = true,
                        maxLines = 1,
