...
val ColorSource.nameLocalized
    @Composable get() = stringResource(
        when (this) {
            ...
            ColorSource.Purple -> R.string.color_source_purple
            ColorSource.Orange -> R.string.color_source_orange
            ColorSource.Green -> R.string.color_source_green
            ColorSource.Blue -> R.string.color_source_blue
        }
    )
