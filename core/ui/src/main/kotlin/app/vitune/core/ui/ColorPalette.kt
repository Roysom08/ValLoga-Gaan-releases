...
private val defaultAccentColor = Color(0xffff69b4).hsl
...
fun accentColorOf(
    ...
    ColorSource.Dynamic -> sampleBitmap?.let { dynamicAccentColorOf(it, isDark) }
        ?: defaultAccentColor
    ColorSource.Purple -> Color(0xff9c27b0).hsl
    ColorSource.Orange -> Color(0xffff9800).hsl
    ColorSource.Green -> Color(0xff4caf50).hsl
    ColorSource.Blue -> Color(0xff2196f3).hsl
}
